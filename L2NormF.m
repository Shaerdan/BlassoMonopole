...
for i=1:SourceNum
    ...
    DistancePQ = sqrt(1.^2+ SourceRadius(i).^2 - 2* SourceRadius(i).*CosGamma);
    F = (2./DistancePQ) - log(1-SourceRadius(i).*CosGamma + SourceRadius(i).*L_out);
